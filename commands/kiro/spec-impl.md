...
After the subagent returns, read `.kiro/specs/$1/tasks.md` and count unchecked tasks (`- [ ]`):

- **If zero unchecked tasks remain**: All tasks are complete. Update `.kiro/specs/$1/spec.json`:
